...
const StatisticGuideBooking = ({booked,deleteFunctionGudies,index}) => {

    const {name,image,experiences,email, cost, date,_id,transaction}=booked;
    console.log(booked)
    ...
    return (
        ...
        <td className="text-sm  font-semibold border-2 shadow-xl ">{email}</td>
...
export default StatisticGuideBooking;